...
void TwoDimensionalHeat(double nmax, double deltax, double deltay, double dt, double hours, double maxlength_X, double maxlength_Y, double minlength_X,double minlength_Y,double alpha,double t1, double t2, double t3, double t4);
...
//Structure to pass/hold vectors
struct heat{
...
int main(){
	...
	TwoDimensionalHeat(nmax,deltax,deltay,dt,hours,maxlength_X,maxlength_Y,minlength_X,minlength_Y,alpha,t1,t2,t3,t4);
	return 0;	
}
