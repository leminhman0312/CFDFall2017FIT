...
%% PLOTTING 
  ...
  title('X vs PRESSURE STEGER-WARMING EXPLICIT','FontSize',18);
  ...
  legend({'Steger Warming','Analytical'},'FontSize',14);
  xlabel('X','FontSize',18);
  title('X vs DENSITY STEGER-WARMING EXPLICIT','FontSize',18)
  ...
  title('X vs VELOCITY STEGER-WARMING EXPLICIT','FontSize',18)
  xt = get(gca, 'XTick');
  set(gca, 'FontSize', 16)
